...
int main(int argc, char *argv[])
{
	...
	/* --- MERGE SORT --- */
	#ifdef LIST_VARIANT
	ADD_TEST(test_merge_sort_list_ascending);
	ADD_TEST(test_merge_sort_list_decending);
	#else 
	ADD_TEST(test_merge_sort_array_ascending);
	ADD_TEST(test_merge_sort_array_descending);
	#endif
